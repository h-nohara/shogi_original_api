...
function deepcopy_Board(Board){
    let new_Board = new Board(Board.all_pieces, Board.is_sente, Board.board_history, Board.legal_moves);
    return new_Board;
}
...
class Board{
    ...
    move(move){
        ...
        if (PieceName_Hand.indexOf(loc_from) >= 0){
            ...
            // 駒オブジェクトを生成して盤上に配置
            let the_piece = new Piece(piece_name, this.is_sente);
        ...
        // 駒を移動させる
            ...
            let piece = this.all_pieces["main"][loc_from];
